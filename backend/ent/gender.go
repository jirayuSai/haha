...
func (e GenderEdges) CustomersOrErr() ([]*Customer, error) {
	if e.loadedTypes[0] {
...
// QueryCustomers queries the customers edge of the Gender.
func (ge *Gender) QueryCustomers() *CustomerQuery {
	return (&GenderClient{config: ge.config}).QueryCustomers(ge)
}
