...
func (e TitleEdges) CustomersOrErr() ([]*Customer, error) {
	if e.loadedTypes[0] {
...
// QueryCustomers queries the customers edge of the Title.
func (t *Title) QueryCustomers() *CustomerQuery {
	return (&TitleClient{config: t.config}).QueryCustomers(t)
}
